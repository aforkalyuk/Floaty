...
//    private var overlayLayer: CAShapeLayer = CAShapeLayer()
    ...
    */
    ...
    fileprivate func setBadgeImage() {
        ...
        badgeImageView.contentMode = UIView.ContentMode.scaleAspectFill
    ...
    fileprivate func setShadow() {
        ...
        circleLayer.shadowColor = UIColor(red: 94.0 / 255.0, green: 140.0 / 255.0, blue: 207.0 / 255.0, alpha: 0.1).cgColor
        circleLayer.shadowOpacity = 1.0
        
        // outter shadow
        layer.shadowOffset = CGSize(width: 0, height: 1)
        layer.shadowRadius = 5
        layer.shadowColor = UIColor(red: 172.0 / 255.0, green: 191.0 / 255.0, blue: 228.0 / 255.0, alpha: 0.3).cgColor
    ...
    @objc internal func keyboardWillShow(_ notification: Notification) {
        guard let keyboardSize: CGFloat = (notification.userInfo?[UIResponder.keyboardFrameBeginUserInfoKey] as? NSValue)?.cgRectValue.size.height,
